...
NonProfitCompletion _$NonProfitCompletionFromJson(Map<String, dynamic> json) {
  return NonProfitCompletion(
    ...
    yearStarted: json['year_started'] as int,
    profile:
        ProfileRepresentation.fromJson(json['profile'] as Map<String, dynamic>),
  );
}
...
NonProfitRep _$NonProfitRepFromJson(Map<String, dynamic> json) {
  return NonProfitRep(
    id: json['id'] as int,
    logo: json['logo'] as String,
    name: json['name'] as String,
