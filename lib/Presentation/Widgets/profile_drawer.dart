        ...
        child: ListView(padding: EdgeInsets.zero, children: <Widget>[
                ...
                onTap: () {
                  context.read<CompletedUserordersBloc>().add(
                      FetchCompletedOrders(
                          completedOrders: widget.profile.orders!));
          ...
          Card(
              ...
              child: ListTile(
                  onTap: () => Navigator.of(context)
                      .pushNamed('/usernonprofits', arguments: widget.profile),
          ...
          Card(
              ...
              child: ListTile(
                  ...
                  onTap: () {
                    context
                        .read<ProfileBloc>()
                        .add(LoadQR(profile: widget.profile));
                    Navigator.of(context)
          ...
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.of(context)
                    .pushNamed('/companyRegister', arguments: widget.profile);
              },
            ),
          ),
          Card(
